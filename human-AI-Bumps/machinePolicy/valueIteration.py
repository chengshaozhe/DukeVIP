...
class RunVI:
    def __init__(self, gridSize, actionSpace, noiseSpace, noise, gamma, goalReward,softmaxBeta):
...
###
        ...
        if visualMap:
            ...
            getPolicy = SoftmaxRLPolicy(Q_dict, self.softmaxBeta)
...
if __name__ == '__main__':
    ...
    runVI = RunVI(gridSize, actionSpace, noiseActionSpace, noise, gamma, goalReward, softmaxBeta)

    goalStates = [(7, 2), (7, 12)]
    obstacles = []
    QDict = runVI(goalStates, obstacles)
    print(QDict)
