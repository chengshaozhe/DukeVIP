...
class DrawNewState():
    ...
    def __call__(self, targetPositionA, targetPositionB, playerPosition, player2Position, ifnoisePlayer1, ifnoisePlayer2):
        ...
        if playerPosition == player2Position:
            ...
            #                [int((playerPosition[0] + self.leaveEdgeSpace + (1-scalingSize)) * self.widthLineStepSpace),
            #                 int((playerPosition[1] + self.leaveEdgeSpace + (1-scalingSize)) * self.heightLineStepSpace)],
            #                int(scalingSize * self.playerRadius))

            # pg.draw.circle(self.screen, self.player2Color,
            #                [int((player2Position[0] + self.leaveEdgeSpace + scalingSize) * self.widthLineStepSpace),
            #                 int((player2Position[1] + self.leaveEdgeSpace + scalingSize) * self.heightLineStepSpace)],
            #                int(scalingSize * self.playerRadius))
