...
# pygame init
    ...
    gridSize = 15
    grid_resolution = 1000  # Fixed grid resolution of 1000x1000
    cell_size = grid_resolution // gridSize  # Size of each cell in the grid

    # Calculate the top-left position to center the grid on the screen
    grid_x = (screen_width - grid_resolution) // 2
    grid_y = (screen_height - grid_resolution) // 2
...
# setup drawing
    ...
    drawBackground = DrawBackground1(screen, grid_surface, gridSize, leaveEdgeSpace, backgroundColor, lineColor, lineWidth, textColorTuple)
...
# game logic
    ...
    def phase3_one_player_two_targets():
