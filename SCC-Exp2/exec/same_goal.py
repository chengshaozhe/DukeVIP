...
# setup drawing
    ...
    formal1Image = pg.transform.scale(pg.image.load(picturePath + 'same_goal.png'), (grid_resolution, grid_resolution))
...
# game logic
    ...
    def formal1_joint_no_bumps(numberOfTrials):
        ...
        normalNoise = NormalNoise(controller)
        awayFromTheGoalNoise = AwayFromTheGoalNoise(controller)
        normalTrial = NormalTrialHumanAISameGoal(controller, drawNewState,drawNewStateWithArrow, drawFixation, normalNoise, checkBoundary)
